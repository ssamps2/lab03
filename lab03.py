...
This program will convert inputed units to their SI equivalents for distance, mass, speed, and temperature.
...
type = str(input().strip())     #user chooses type of unit: distance, mass, speed, temp
